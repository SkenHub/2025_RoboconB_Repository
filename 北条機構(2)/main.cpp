...
CanData can_data_r;
uint8_t candata_r[8],can_enc_data[8];
...
void can_rceive(void){
	...
	if(can_data_r.rx_stdid == 0x400){//canIDが0x320なら実行
		for(int m=0;m<8;m++){
	  	...
	  	if(candata_r[0] && 0x20 == 32){
	  	  botan[0] = 1;
	  	}
	  	else{
	  	  botan[0] = 0;
	  	}
	  	if(candata_r[0] && 0x40 == 64){
	  	  botan[1] = 1;
	  	}
	  	else{
	  	  botan[1] = 0;
	  	}
	  	if(candata_r[0] && 0x80 == 128){
	  	  botan[2] = 1;
	  	}
	  	else{
	  	  botan[2] = 0;
	  	}
	  	if(candata_r[1] && 0x01 == 1){
	  	  botan[3] = 1;
	  	}
	  	else{
	  	  botan[3] = 0;
	  	}
	  	if(candata_r[1] && 0x02 == 2){
	  	  botan[4] = 1;
	  	}
	  	else{
	  	  botan[4] = 0;
	  	}
	  	if(candata_r[1] && 0x04 == 4){
	  	  botan[5] = 1;
	  	}
	  	else{
	  	  botan[5] = 0;
	  	}
	  	if(candata_r[1] && 0x08 == 8){
	  	  botan[6] = 1;
	  	}
	  	else{
	  	  botan[6] = 0;
	  	}
	  	if(candata_r[1] && 0x10 == 16){
	  	  botan[7] = 1;
	  	}
	  	else{
	  	  botan[7] = 0;
