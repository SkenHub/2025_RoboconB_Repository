...
int timer_counter[6] = {499,499,499,499,499,499};
int swich[6];
int rimits[10];
...
int main(void){
	...
	while(1){
		...
		//ボタン１を押したときに実行
	    if(botan[10] == 1 && mtr1_sg[0] == 0){//1押し
            if(limitdata[0] != 1){
                mtr[0].write(50);
                if(ugoki_checker[1] == 0){
                	send_data_DD[5] = 1;
                	ugoki_checker[1] = 1;
                }
            }
		...
		else if(botan[10] == 2 && ugoki_checker[0] == 1){//2押し
			if(mtr1_sg[1] == 0){
			    mtr1_sg[1] = 1;
			    swich[1] = 1;
			}
	    ...
	    /*if(botan[10] == 1 && mtr1_sg[4] == 0){//1押し
	    	mtr1_sg[4] = 1;
	    	swich[4] = 1;
	    }
	    else if(botan[10] >= 2){//2押し以上
	    	if((mtr1_sg[5] == 0)){
	    		mtr[1].write(-75);
	    		mtr[2].write(75);
	    		mtr1_sg[5] = 1;
	    ...
	    if(botan[8] == 1 && mtr1_sg[4] == 0){//1押し
	    	mtr1_sg[4] = 1;
	    	swich[4] = 1;
	    }
	    else if(botan[8] >= 2){//2押し以上
	    	if((mtr1_sg[5] == 0)){
	    		mtr[2].write(75);
	    		mtr1_sg[5] = 1;
	    		swich[5] = 1;
	    ...
	    //ボタン４を押したときに実行
	    if(botan[11] == 1 && mtr1_sg[18] == 0){//1押し
	    	 if(limitdata[0] != 1){
	    	     mtr[0].write(50);
	    	 }
	    	 else if(limitdata[0] == 1){
	    ...
	    else if(botan[11] >= 2 && mtr1_sg[18] == 1){//2押し以上
	    	 if(enc_sinti[0]<=170){
	    	     mtr[0].write(-50);
	    	 }
	    ...
	    else if(botan[] >= 2 && mtr1_sg[19] == 1){//2押し以上
	    	 if(enc_sinti[0]<=170){
	    	     mtr[0].write(-70);
	    	 }
	    	 else if(enc_sinti[0]>=170){
